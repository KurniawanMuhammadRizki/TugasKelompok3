	 ...
	 <div class="col-md-12">
		...
		<p align="right">Tanggal Pesan : <?php echo e($pesanan->tanggal); ?></p>
		  <table class="table table-striped">
						...
						<td align="left">Rp <?php echo e(number_format($pesanan_detail->barang->harga)); ?></td>
						<td align="left" >Rp <?php echo e(number_format($pesanan_detail->jumlah_harga)); ?></td>
						<td>
						...
						<td>
							<a href ="<?php echo e(url('konfirmasi-check-out')); ?>" class="btn btn-success">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\peralatanOlahraga\resources\views/pesan/check_out.blade.php ENDPATH**/ ?>