        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah sukses dicheck out selanjutnya untuk pembayaran silahkan transfer di rekening <strong>Bank BRI Nomer Rekening : 034101-000743-303</strong> atas nama <strong>Randi mursalim </strong> dengan nominal : <strong>Rp. <?php echo e(number_format($pesanan->jumlah_harga)); ?></strong></h5>
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\peralatanOlahraga\resources\views/history/detail.blade.php ENDPATH**/ ?>